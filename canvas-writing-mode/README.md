...
We can add 2 attributes eash with a few potential values rather than their cross-product of new methods. Borrowing CSS terminology also aids in developer
